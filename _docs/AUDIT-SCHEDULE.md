...
| 2026-06-23 | Index recovery experiment (17 unindexed articles) | 14-day check-in on the 2026-06-09 internal-linking pass (commit `d0a34b5`). Baseline: 53/70 articles indexed; 8 never crawled, 10 crawled-not-indexed. Re-export GSC coverage and recount both buckets. Same check-in date as the christian-budgeting-apps snippet experiment — do both in one GSC visit. | Success signal: 6+ of the never-crawled 8 indexed by day 14. If first crawls still haven't happened, link weight alone isn't forcing discovery — escalate (re-submission round 2, or sitemap lastmod refresh). |
