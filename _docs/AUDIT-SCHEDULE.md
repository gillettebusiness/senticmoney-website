...
| 2026-06-23 | Index recovery experiment (17 unindexed articles) | 14-day check-in on the 2026-06-09 internal-linking pass (commit `d0a34b5`). Baseline: 53/70 articles indexed; 8 never crawled, 10 crawled-not-indexed. Re-export GSC coverage and recount both buckets. Same check-in date as the christian-budgeting-apps snippet experiment — do both in one GSC visit. Also export the GSC 404 and redirect-error drilldowns to capture the specific URLs for the GSC-cleanup tech debt item. | Success signal: 6+ of the never-crawled 8 indexed by day 14. If first crawls still haven't happened, link weight alone isn't forcing discovery — escalate (re-submission round 2, or sitemap lastmod refresh). |
| 2026-07-09 | Index recovery experiment (17 unindexed articles) | 30-day check-in on the same experiment. Re-export GSC coverage and recount. Same check-in date as the christian-budgeting-apps snippet experiment — do both in one GSC visit. | Success signal: 5+ of the crawled-declined 10 indexed by day 30. Persistent decliners after fresh link weight + resubmission are consolidation candidates (see teen/youth cluster review in Section 2). |
...
| Teen/youth cluster consolidation review | During the portfolio-wide CTR audit, or sooner if the index recovery 30-day check-in (2026-07-09) shows money-management-for-youth still declined | Five overlapping pages: teaching-teens-to-budget, financial-management-for-teens, how-to-budget-as-a-teenager indexed; money-management-for-youth declined by Google (consolidation suspect — got minimal one-link treatment in the 2026-06-09 recovery pass by design); budget-advice-for-young-adults never crawled. Decide consolidate-vs-differentiate. |
| Couples cluster watch | During the portfolio-wide CTR audit | Three overlapping pages: best-budget-apps-for-couples-2026 and budget-software-for-couples indexed; couples-budgeting never crawled (in the 2026-06-09 recovery pass). If couples-budgeting stays unindexed after recovery check-ins, treat as the same consolidate-vs-differentiate question as the teen cluster. |
| GSC-cleanup tech debt addendum: www host may not 301 to apex | Next GSC-cleanup session | GSC coverage export 2026-06-09 shows an indexed duplicate `https://www.senticmoney.com/features`, suggesting the www host may not 301 to apex. Verify alongside the existing 2x404 + 1 redirect error item. |
...
|---|---|---|---|---|
| 2026-06-09 | Index recovery experiment — 17 unindexed articles | GSC coverage export 2026-06-09: 70 published articles, 53 indexed. Sitemap (85 URLs) and robots.txt verified clean. Two failure buckets: 8 URLs DISCOVERED-never-crawled (incl. the author page) with near-zero internal link weight; 10 articles CRAWLED-not-indexed (Google evaluated and declined; 50-30-20 recrawled 2026-06-02, still declined). | Internal-linking pass per INDEX-RECOVERY.md matrix: 25 body-content links added across 20 source articles (16 matrix source-target pairs already linked — no duplicates added), freshness bumps on all edited files. Commit `d0a34b5`. GSC URL Inspection submissions scheduled manually: never-crawled 8 on 2026-06-10, crawled-not-indexed 10 on 2026-06-11. | Pending. Check-ins 2026-06-23 (14-day) and 2026-07-09 (30-day) — rows in Section 1. |
